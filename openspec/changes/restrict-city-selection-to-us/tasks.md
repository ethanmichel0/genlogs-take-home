...
- [ ] 4.1 Manually verify with the live Google autocomplete boundary that representative non-US cities do not appear in normal suggestions and that US locality suggestions remain available in both fields.
