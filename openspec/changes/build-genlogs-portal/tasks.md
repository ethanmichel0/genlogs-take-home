...
- [ ] 5.4 Deploy the backend and frontend to public HTTPS endpoints, smoke-test all three carrier branches plus route/error behavior, and record the working frontend URL and backend base URL in the README.
- [ ] 5.5 Run final automated checks and review runtime dependencies and components to confirm no database, authentication, camera/image processing, Redux, queues, or unrelated production architecture was introduced.
